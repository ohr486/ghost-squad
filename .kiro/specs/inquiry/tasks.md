...
- [x] 8.2 InquiryFormコンポーネントのテストを作成する
...
- [x] 9.2 InquiryListコンポーネントのテストを作成する
  - 問い合わせ一覧の表示をテストする
  - ページネーション操作のテストを実装する
...
- [x] 10.1 InquiryDetailコンポーネントを実装する
...
- [x] 10.2 InquiryDetailコンポーネントのテストを作成する
  - 問い合わせ詳細の表示をテストする
  - 編集モードの切り替えをテストする
  - インライン編集と保存をテストする
  - 承認操作のテストを実装する
...
- [x] 11.2 主要ユーザーフローのエンドツーエンドテストを作成する
