...
def test_database_url_priority():
    ...
    original_env = {}
    env_vars = ["DATABASE_URL", "DATABASE_HOST", "DATABASE_PORT", 
    ...
    try:
        ...
        expected_url1 = "postgresql://test-user:test-pass@test-host:9999/test-db"
        ...
        print("\n📋 Test 2: DATABASE_URL takes priority")
        os.environ["DATABASE_URL"] = "postgresql://priority-user:priority-pass@priority-host:8888/priority-db"
        ...
        expected_url2 = "postgresql://priority-user:priority-pass@priority-host:8888/priority-db"
...
def test_database_info():
    ...
    try:
        ...
        required_keys = ["scheme", "host", "port", "database", "username", "password_set", "url_source"]
