...
from seed_data import seed_data, clear_data, create_sample_inquiries, create_sample_stories, create_sample_templates
from models.database.inquiry import InquiryModel
from models.database.story import StoryModel
from models.database.template import StoryTemplateModel
from models.enums import InquiryStatus, StoryStatus, Priority, StoryCategory, StoryPattern
...
class TestSeedDataIntegration:
    ...
    def test_create_sample_stories_integration(self, clean_database):
        ...
        # Verify in database - should have 4 stories (2 for first inquiry, 1 for second, 1 for third)
    ...
    def test_full_seed_data_integration(self, clean_database):
        ...
        import seed_data
        original_session_local = seed_data.SessionLocal
        
        def mock_session_local():
            return session
        
        seed_data.SessionLocal = mock_session_local
        ...
        try:
            ...
            seed_data.SessionLocal = original_session_local
    ...
    def test_clear_data_integration(self, clean_database):
        ...
        assert session.query(StoryModel).count() == 4  # Updated to match new story count
    ...
    def test_seed_data_idempotency(self, clean_database):
        ...
        try:
            # Run seeding twice
            seed_data.seed_data()
            seed_data.seed_data()  # Should skip due to existing data
