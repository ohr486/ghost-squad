...
class StoryModel(Base):
    ...
    status = Column(String(50), nullable=False, default=StoryStatus.PENDING_REVIEW.value)
    ...
    story_metadata = Column(JSON, nullable=False)  # Renamed to avoid SQLAlchemy conflict
